...
@override
  Widget build(BuildContext context) {
    ...
    String autho = authenticationController.userName;
    ...
    if(titulo.isNotEmpty && desc.isNotEmpty && autho.isNotEmpty) {
    
     
      Map<String, String> blog = {'userId': userId ,'titulo': titulo, 'desc': desc, 'date': date, 'auth': autho};
